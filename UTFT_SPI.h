...
static struct _current_font	cfont;
static uint8_t display_model, display_transfer_mode,model;
static uint8_t orient;
static uint8_t fcolorr,fcolorg,fcolorb;
static uint8_t bcolorr,bcolorg,bcolorb;
